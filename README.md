...
Unfortunately the XML format of the Wikipedia dump is somewhat proprietary and inaccessible. WikipediaExport tries to solve this problem by converting the XML dump to either plain text or JSON - two formats that can be easily consumed by many tools.
